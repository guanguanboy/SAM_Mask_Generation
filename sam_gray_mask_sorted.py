...
for i, filename in enumerate(os.listdir(sourcedir)):
    if filename.endswith('.jpg') or filename.endswith('.png'):
        ...
        #img[:,:,3] = 0
            ...
            # Binary
        os.makedirs(f'{sourcedir}_semanticB_sorted', exist_ok=True)
        ...
        #Color
        os.makedirs(f'{sourcedir}_semantic_gray_sorted_reverted', exist_ok=True)
        save_path = os.path.join(f'{sourcedir}_semantic_gray_sorted_reverted', f'{os.path.splitext(filename)[0]}_semantic.png')
        print(save_path)
